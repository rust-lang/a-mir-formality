...
(define-metafunction formality-decl
  ...
  [;; For a fn declaration declared in the crate C, like the following:
   ...
   (crate-item-ok-goal _ (fn FnId KindedVarIds Tys_arg Ty_ret (WhereClause ...) FnBody))
  ...
  [;; For a trait declaration declared in the crate C, like the following:
   ...
   (crate-item-ok-goal CrateDecls (trait TraitId KindedVarIds (WhereClause ...) (TraitItem ...)))
   (∀ KindedVarIds
