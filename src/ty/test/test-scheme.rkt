...
(module+ test
  (redex-let*
   ...
   [((Env_1 () (Ty_T)) (term (instantiate-quantified EmptyEnv (∀ ((type T)) ()))))
    ...
    (Env_4 (term (env-with-var-mapped-to Env_3 Ty_A (rigid-ty (Ref ()) (Lt_I (scalar-ty i32))))))
    (Env_5 (term (env-with-var-mapped-to Env_4 Ty_B (rigid-ty (Ref ()) (Lt_J (scalar-ty i32))))))
