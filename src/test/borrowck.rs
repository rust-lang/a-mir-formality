...
fn declared_transitive_universal_region_relationship() {
    crate::assert_ok!(
        [
            crate Foo {
                fn foo<lt a, lt b, lt c>(&a u32, &b u32) -> &c u32
                where
                    a: b,
                    b: c,
                = minirust(v1, v2) -> v0 {
