...
(define-metafunction formality-rust
  lower-to-decl/ImplItem : FeatureIds Rust/ImplItem -> ImplItem

  [(lower-to-decl/ImplItem _ (type AssociatedTyId KindedVarIds = Rust/Ty where [Rust/WhereClause ...]))
   (type AssociatedTyId KindedVarIds = (user-ty Rust/Ty) where [(lower-to-decl/WhereClause Rust/WhereClause) ...])]

  [(lower-to-decl/ImplItem FeatureIds Rust/FnDecl)
